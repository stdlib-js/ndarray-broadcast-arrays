...
tape( 'the function returns read-only ndarray instances (1 array, list)', function test( t ) {
	var out;
	var x;
...
tape( 'the function returns read-only ndarray instances (1 array, argument)', function test( t ) {
	var out;
	var x;
...
tape( 'the function returns read-only ndarray instances (2 arrays, list)', function test( t ) {
	var out;
	var x;
	var y;
	...
	t.strictEqual( isReadOnly( out[ 1 ] ), true, 'returns expected value' );

	t.end();
});

tape( 'the function returns read-only ndarray instances (2 arrays, arguments)', function test( t ) {
	var out;
	var x;
	var y;
